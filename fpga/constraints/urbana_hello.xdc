# -----------------------------------------------------------------------------
# urbana_hello.xdc
# Constraints for the RealDigital Urbana board (xc7s50csga324-1) hello-world
# CPU bringup.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# UART (to on-board USB bridge)
#   Board pin names are from the HOST's perspective:
#     uart_rxd = A16 = host RX (FPGA OUTPUT) ← what we drive
#     uart_txd = B16 = host TX (FPGA INPUT)
# -----------------------------------------------------------------------------
