// Sim-only behavioural 1×2 AXI4 router sized for the Linux memory map.
//
// Same interface as axi4_router_1x2 but decodes on addr[31:28]:
//   Slave 0 — addr[31:28] == 4'h4  (DDR @ 0x4000_0000 / 256 MiB aperture)
//   Slave 1 — addr[31:28] == 4'hC  (UartLite @ 0xC000_0000 / 256 MiB aperture)
// Anything outside returns DECERR via the internal stub.
//
// On FPGA this slot is filled by Vivado axi_crossbar + axi_protocol_converter.
// Single-beat / single-outstanding — matches axi4_master's shape.

module axi4_router_linux #(
    parameter int unsigned ID_W = 4
) (
    input  logic clk,
    input  logic rst,

    // ---- AXI4-full master port ----
